...
\begin{enumerate}
  ...
  After this step, the image in Figure \ref{fig:cow_black_and_white_denoised} is formed.

  \begin{figure}
    \centering
		\caption{Black-and-white cow image after being denoised}
		\label{fig:cow_black_and_white_denoised}
  ...
  After this step, the image in Figure \ref{fig:cow_black_and_white_denoised_vectorized} is formed.

  \begin{figure}
    \centering
		\caption{Black-and-white cow image after being denoised and converted to Scalable Vector Graphics}
		\label{fig:cow_black_and_white_denoised_vectorized}
...
\appendix
\chapter{Level Screenshots}\label{sec:appendix_level_screenshots}
...
\chapter{Parameter Values}\label{sec:appendix_parameter_values}
