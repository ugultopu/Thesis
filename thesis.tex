...
\caption{Example of structures built using the PCG of Ferreira et al.
\cite{ferreira18}.}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
		\caption{Black-and-white cow image after being denoised and vectorized}
...
\begin{figure}[H]
	\caption{Generated structure with primary blocks and platform blocks}
...
\begin{figure}[H]
	\caption{Generated structure with primary blocks, platform blocks and pigs}
